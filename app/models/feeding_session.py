...
class FeedingSession(Base):
    ...
    total_kcal: Mapped[float] = mapped_column(Numeric(7, 2), nullable=False, default=0, server_default='0')
    protein_g: Mapped[float] = mapped_column(Numeric(6, 2), nullable=False, default=0, server_default='0')
    fat_g: Mapped[float] = mapped_column(Numeric(6, 2), nullable=False, default=0, server_default='0')
    ...
    items_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default='0')
    score: Mapped[int] = mapped_column(SmallInteger, nullable=False, default=0, server_default='0')
    quality: Mapped[str] = mapped_column(String(10), nullable=False, server_default='unknown')
